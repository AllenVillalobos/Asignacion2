...
namespace Asignacion2.Modelos
{
    ...
    public class Mascotas
    {
        ...
        /// <summary>Lista de alergias que padece la mascota (si aplica).</summary>
        private String alergias { get; set; }

        /// <summary>Fecha de nacimiento de la mascota.</summary>
        private DateTime fechaNacimiento { get; set; }

        /// <summary>Sexo de la mascota. Usualmente 'M' o 'F'.</summary>
        ...
        /// Omite campos que no cambian (como sexo o fecha de nacimiento).
        /// </summary>
