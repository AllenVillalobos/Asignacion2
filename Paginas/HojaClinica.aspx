  ...
  <form id="form1" runat="server">
    <div class="clinica-container">
      ...
      <div class="gradient-card">
        ...
        <asp:TextBox ReadOnly="true" ID="txtUsuarios" runat="server" CssClass="form-control" /><br /><br />
      ...
      <div class="gradient-card">
        ...
        <asp:TextBox ID="txtIDMascota" runat="server" CssClass="form-control" /><br /><br />
        ...
        <asp:TextBox ID="txtFechaNacimiento" runat="server" CssClass="form-control" ReadOnly="true" /><br /><br />
